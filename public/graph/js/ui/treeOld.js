var Tree = (function () {
        ...
        self.addSelectionToQuery = function (state) {
            ...
            if ((new Date() - self.checkboxChangeTimeStamp) > 500) {
                setTimeout(function () {
                        ...
                        if (false && cardId) {//update
                            ...
                            // si la derniere carte est de type nodeSet
                            if(buildPaths.queryObjs.length-1 >0 && buildPaths.queryObjs[buildPaths.queryObjs.length-1].queryObject.type.indexOf("nodeSet")==0)
                            context.currentQueryCardIndex=buildPaths.queryObjs.length-1;//update de la carte
                            else
                                context.currentQueryCardIndex=-1// creation nouvelle carte
