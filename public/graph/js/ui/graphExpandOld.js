var GraphExpand = (function () {
            ...
            result0.forEach(function (result) {
                result.nodes.forEach(function (node) {
                    if (mArrayIds.indexOf(node._id) < 0) {
                        ...
                        if (!visjsGraph.nodesDS.get(node._id)) {
                ...
                visjsGraph.edgesDS.get().forEach(function (edge) {
        ...
        Cypher.executeCypher(cypher, function (err, result) {
                    ...
                    line.mArray.forEach(function (neoNode) {
                        ...
                        if (!visjsGraph.nodesDS.get(neoNode._id)) {
                            ...
                            if (newNodeIds.indexOf(neoNode._id) < 0) {
                                ...
                                var visjsNode = visJsDataProcessor.getVisjsNodeFromNeoNode(neoNode, false);
                                newNodes.push(visjsNode);
                            }
                        }
            ...
            if (showAllNewNodesrelations) {
                ...
                Cypher.executeCypher(cypher, function (err, result) {
                        ...
                        visjsGraph.nodesDS.get().forEach(function (node) {
                            ...
                            if ((""+node.id).indexOf("cluster") == 0) {
                                ...
                                if (clusterIds && clusterIds.indexOf(line.nId) > -1) {
                                    var relPId = "" + Math.random();
                                    var visjsEdge2 = visJsDataProcessor.getVisjsRelFromNeoRel(line.nId, node.id, relPId, "expand2", {});
                                    newEdges2.push(visjsEdge2);
                    ...
                    visjsGraph.edgesDS.update(newEdges2);
    ...
    self.openCluster = function () {
        ...
        Cypher.executeCypher(cypher, function (err, result) {
            ...
            visjsGraph.nodesDS.update({id: clusterId, hidden: true});
    ...
    self.closeCluster = function (clusterId) {
        ...
        visjsGraph.edgesDS.update(edges);
